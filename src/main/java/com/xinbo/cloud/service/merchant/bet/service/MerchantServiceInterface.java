...
import com.xinbo.cloud.service.merchant.bet.service.fallback.MerchantServiceInterfaceFallback;
 ...
 * @desc 商户信息接口
 */
@FeignClient(name = "cloud-service-merchant", fallback = MerchantServiceInterfaceFallback.class)
